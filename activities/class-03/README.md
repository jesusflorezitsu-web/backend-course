...
| `proyecto/` | Implementación (ver su `README.md`) |

## Proyecto

La implementación vive en [`proyecto/`](proyecto/README.md): API de solicitudes de
...
3. **Fase 2 (con IA):** implementación en `proyecto/` a partir del starter de la clase 3;
...
- El `project/` raíz queda **reservado** para el proyecto personal de fin de trimestre;
  esta clase usó su carpeta propia (`proyecto/`).