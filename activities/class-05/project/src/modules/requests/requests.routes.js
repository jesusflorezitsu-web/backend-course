// HTTP layer of the requests module. The router is mounted behind the
// `authenticate` middleware (app.js), so every handler receives req.auth and
// passes the trusted actor as the FIRST argument to the service.
