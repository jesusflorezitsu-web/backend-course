// Issues and verifies the workshop JWT with the `jose` library.
// Decoding lets you read; VERIFYING (signature, algorithm, issuer, audience
// and expiry) lets you trust. The token is signed, NOT encrypted: the
// payload must never carry sensitive material.
