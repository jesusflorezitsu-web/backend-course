...
Repositorio único de la materia **Desarrollo Backend**. Proyecto transversal: **Sistema de gestión de solicitudes**.
...
Requisito general: Node.js LTS (`node --version`).
...
| 04 | `class-04-design` / (pendiente `class-04-submission`) | ✅ |